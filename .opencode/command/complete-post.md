...
3. **Investiga** el recurso de verdad descargando la web oficial / el repo y buscando en la web si hace falta. Verifica qué es, su stack, si está activo o archivado, y si el enlace sigue siendo correcto (corrígelo si cambió de owner/URL). No inventes nada.
...
6. Ejecuta `pnpm build` para validar.
