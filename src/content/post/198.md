...
- [Web oficial](https://vitest.dev)
- [Repositorio en GitHub](https://github.com/vitest-dev/vitest)
- [Guía de migración desde Jest](https://vitest.dev/guide/migration.html)
