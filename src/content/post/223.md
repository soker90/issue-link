...
tags:
  ...
  - javascript
stars: 3530
lastCommit: 2024-08-17
---

## Qué es

Este repositorio es la traducción al español de la popular guía _Clean Code JavaScript_ de Ryan McDermott. Adapta los principios del célebre libro _"Clean Code"_ de Robert C. Martin ("Uncle Bob") al lenguaje JavaScript, ofreciendo ejemplos prácticos de cómo escribir código legible, reutilizable y fácil de refactorizar y mantener en proyectos reales.
